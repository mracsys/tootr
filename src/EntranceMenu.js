            ...
            return (
                ...
                >
                    {Object.keys(this.props.entrancePool).sort().map((areaCategory, l) => {
                        if (((areaCategory === this.props.title && !(this.props.oneWay || this.props.isReverse)) || areaCategory === "Warp Songs" || this.props.entrancePool[areaCategory].length === 0) && this.props.connector === false) {
                            return null;
                        } else {
