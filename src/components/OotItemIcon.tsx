...
const itemMap: IconDict = {
    ...
    'Giants Knife': { img: '/images/OoT_Giants_Knife_Icon.png', rSub: 'K' },
    'Biggoron Sword': { img: '/images/OoT_Giants_Knife_Icon.png', rSub: 'B' },
    'Large Sword': { img: '/images/OoT_Giants_Knife_Icon.png' },
    ...
    'Green Rupee': { img: '/images/green_rupee_vertical.png' },
    'Blue Rupee': { img: '/images/blue_rupee_vertical.png' },
    'Red Rupee': { img: '/images/red_rupee_vertical.png' },
    'Purple Rupee': { img: '/images/purple_rupee_vertical.png' },
    ...
    'Silver Rupee (Ganons Castle Spirit Trial)': { img: '/images/silver_rupee_vertical.png', rSub: 'GC', text: 'Spirit Trial' },
    'Silver Rupee (Ganons Castle Light Trial)': { img: '/images/silver_rupee_vertical.png', rSub: 'GC', text: 'Light Trial' },
    'Silver Rupee (Ganons Castle Fire Trial)': { img: '/images/silver_rupee_vertical.png', rSub: 'GC', text: 'Fire Trial' },
    'Silver Rupee (Ganons Castle Shadow Trial)': { img: '/images/silver_rupee_vertical.png', rSub: 'GC', text: 'Shadow Trial' },
    'Silver Rupee (Ganons Castle Water Trial)': { img: '/images/silver_rupee_vertical.png', rSub: 'GC', text: 'Water Trial' },
    'Silver Rupee (Ganons Castle Forest Trial)': { img: '/images/silver_rupee_vertical.png', rSub: 'GC', text: 'Forest Trial' },
    ...
    'Silver Rupee Pouch (Ganons Castle Spirit Trial)': { img: '/images/silver_rupee_pouch.png', rSub: 'GC', text: 'Spirit Trial' },
    'Silver Rupee Pouch (Ganons Castle Light Trial)': { img: '/images/silver_rupee_pouch.png', rSub: 'GC', text: 'Light Trial' },
    'Silver Rupee Pouch (Ganons Castle Fire Trial)': { img: '/images/silver_rupee_pouch.png', rSub: 'GC', text: 'Fire Trial' },
    'Silver Rupee Pouch (Ganons Castle Shadow Trial)': { img: '/images/silver_rupee_pouch.png', rSub: 'GC', text: 'Shadow Trial' },
    'Silver Rupee Pouch (Ganons Castle Water Trial)': { img: '/images/silver_rupee_pouch.png', rSub: 'GC', text: 'Water Trial' },
    'Silver Rupee Pouch (Ganons Castle Forest Trial)': { img: '/images/silver_rupee_pouch.png', rSub: 'GC', text: 'Forest Trial' },
    ...
    'Rupees (200)': { img: '/images/yellow_rupee_vertical.png' },
    'Rupee (1)': { img: '/images/green_rupee_vertical.png' },
    'Rupees (5)': { img: '/images/blue_rupee_vertical.png' },
    'Rupees (20)': { img: '/images/red_rupee_vertical.png' },
    'Rupees (50)': { img: '/images/purple_rupee_vertical.png' },
    'Rupee (Treasure Chest Game) (1)': { img: '/images/green_rupee_vertical.png' },
    'Rupees (Treasure Chest Game) (5)': { img: '/images/blue_rupee_vertical.png' },
    'Rupees (Treasure Chest Game) (20)': { img: '/images/red_rupee_vertical.png' },
    'Rupees (Treasure Chest Game) (50)': { img: '/images/purple_rupee_vertical.png' },
