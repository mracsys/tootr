...
class LocationCheck extends React.Component {
    render() {
        ...
        return (
            <div className={this.props.classes.locationContainer} key={this.props.lkey}>
                {
                ...
                <Typography className={this.props.classes.locationText}><em>{this.props.allAreas.locations[this.props.location].alias}</em></Typography>
                {
                    this.props.allAreas.locations[this.props.location].check === "" ?
                        <IconButton component="span" onClick={() => this.props.handleCheck(this.props.location)}><CheckBoxOutlineBlankIcon /></IconButton> :
                        <IconButton component="span" onClick={() => this.props.handleUnCheck(this.props.location)}><DoneIcon /></IconButton>
                }
            </div>
        );
    }
